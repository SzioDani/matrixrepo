...
ICON_SEARCH_TITLE= os.path.join(MEDIA_PATH, "search.png")
ICON_BROWSE_GENRE= os.path.join(MEDIA_PATH, "genre.png")
ICON_BROWSE_YEAR= os.path.join(MEDIA_PATH, "year.png")
ICON_SEARCH_PERSON= os.path.join(MEDIA_PATH, "person.png")
ICON_FROM_CLIPBOARD= os.path.join(MEDIA_PATH, "clipboard.png")
ICON_FAVORITES= os.path.join(MEDIA_PATH, "star_neon.png")
ICON_HISTORY= os.path.join(MEDIA_PATH, "history.png")
